...
# categories 1 = virus, 2 = rootkit, 3 is worm 4 = trojan, 5 = backdoor

session.add_all([
Item(title="iloveyou", description=virus.get("iloveyou"),category=1, creator=1),
Item(title="Melissa", description=virus.get("Melissa"),category=1, creator=1),
Item(title="Code Red", description=worm.get("Code Red"),category=3, creator=1),
Item(title="Sasser", description=worm.get("Sasser"),category=3, creator=1),
Item(title="Beast", description=trojan.get("Beast"),category=4, creator=1),
Item(title="Njrat", description=trojan.get("Njrat"),category=4, creator=2),
Item(title="Zeus", description=trojan.get("Zeus"),category=4, creator=2),
Item(title="Back Orifice", description=backdoor.get("Back Orifice"),\
     category=5, creator=2),
